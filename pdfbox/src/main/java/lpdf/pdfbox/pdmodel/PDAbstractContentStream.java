...
import lpdf.pdfbox.pdmodel.graphics.color.PDDeviceCMYK;
import lpdf.pdfbox.pdmodel.graphics.color.PDDeviceGray;
import lpdf.pdfbox.pdmodel.graphics.color.PDDeviceN;
import lpdf.pdfbox.pdmodel.graphics.color.PDDeviceRGB;
import lpdf.pdfbox.pdmodel.graphics.color.PDICCBased;
import lpdf.pdfbox.pdmodel.graphics.color.PDPattern;
import lpdf.pdfbox.pdmodel.graphics.color.PDSeparation;
...
import lpdf.pdfbox.util.NumberFormatUtil;
...
abstract class PDAbstractContentStream implements Closeable {
    ...
    public void setNonStrokingColor(RgbColor color) throws IOException {
