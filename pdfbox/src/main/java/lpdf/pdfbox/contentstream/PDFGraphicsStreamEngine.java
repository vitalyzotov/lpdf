...
import lpdf.pdfbox.contentstream.operator.color.SetNonStrokingDeviceCMYKColor;
import lpdf.pdfbox.contentstream.operator.color.SetNonStrokingDeviceGrayColor;
import lpdf.pdfbox.contentstream.operator.color.SetNonStrokingDeviceRGBColor;
import lpdf.pdfbox.contentstream.operator.color.SetStrokingColor;
import lpdf.pdfbox.contentstream.operator.color.SetStrokingColorN;
import lpdf.pdfbox.contentstream.operator.color.SetStrokingColorSpace;
import lpdf.pdfbox.contentstream.operator.color.SetStrokingDeviceCMYKColor;
import lpdf.pdfbox.contentstream.operator.color.SetStrokingDeviceGrayColor;
import lpdf.pdfbox.contentstream.operator.color.SetStrokingDeviceRGBColor;
import lpdf.pdfbox.contentstream.operator.graphics.AppendRectangleToPath;
import lpdf.pdfbox.contentstream.operator.graphics.BeginInlineImage;
import lpdf.pdfbox.contentstream.operator.graphics.ClipEvenOddRule;
import lpdf.pdfbox.contentstream.operator.graphics.ClipNonZeroRule;
import lpdf.pdfbox.contentstream.operator.graphics.CloseAndStrokePath;
import lpdf.pdfbox.contentstream.operator.graphics.CloseFillEvenOddAndStrokePath;
import lpdf.pdfbox.contentstream.operator.graphics.CloseFillNonZeroAndStrokePath;
import lpdf.pdfbox.contentstream.operator.graphics.ClosePath;
import lpdf.pdfbox.contentstream.operator.graphics.CurveTo;
import lpdf.pdfbox.contentstream.operator.graphics.CurveToReplicateFinalPoint;
import lpdf.pdfbox.contentstream.operator.graphics.CurveToReplicateInitialPoint;
import lpdf.pdfbox.contentstream.operator.graphics.DrawObject;
import lpdf.pdfbox.contentstream.operator.graphics.EndPath;
import lpdf.pdfbox.contentstream.operator.graphics.FillEvenOddAndStrokePath;
import lpdf.pdfbox.contentstream.operator.graphics.FillEvenOddRule;
import lpdf.pdfbox.contentstream.operator.graphics.FillNonZeroAndStrokePath;
import lpdf.pdfbox.contentstream.operator.graphics.FillNonZeroRule;
import lpdf.pdfbox.contentstream.operator.graphics.LegacyFillNonZeroRule;
import lpdf.pdfbox.contentstream.operator.graphics.LineTo;
import lpdf.pdfbox.contentstream.operator.graphics.MoveTo;
import lpdf.pdfbox.contentstream.operator.graphics.ShadingFill;
import lpdf.pdfbox.contentstream.operator.graphics.StrokePath;
...
import lpdf.pdfbox.contentstream.operator.state.SetFlatness;
import lpdf.pdfbox.contentstream.operator.state.SetGraphicsStateParameters;
import lpdf.pdfbox.contentstream.operator.state.SetLineCapStyle;
import lpdf.pdfbox.contentstream.operator.state.SetLineDashPattern;
import lpdf.pdfbox.contentstream.operator.state.SetLineJoinStyle;
import lpdf.pdfbox.contentstream.operator.state.SetLineMiterLimit;
import lpdf.pdfbox.contentstream.operator.state.SetLineWidth;
