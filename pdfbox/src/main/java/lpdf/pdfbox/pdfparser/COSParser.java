...
import lpdf.pdfbox.cos.ICOSParser;
import lpdf.io.IOUtils;
import lpdf.io.RandomAccessRead;
import lpdf.io.RandomAccessReadView;
import lpdf.pdfbox.pdfparser.XrefTrailerResolver.XRefType;
import lpdf.pdfbox.pdmodel.encryption.AccessPermission;
import lpdf.pdfbox.pdmodel.encryption.DecryptionMaterial;
...
import lpdf.pdfbox.pdmodel.encryption.PublicKeyDecryptionMaterial;
import lpdf.pdfbox.pdmodel.encryption.SecurityHandler;
import lpdf.pdfbox.pdmodel.encryption.StandardDecryptionMaterial;
...
public class COSParser extends BaseParser implements ICOSParser
{
    ...
    public static final String SYSPROP_EOFLOOKUPRANGE =
            "lpdf.pdfbox.pdfparser.nonSequentialPDFParser.eofLookupRange";
